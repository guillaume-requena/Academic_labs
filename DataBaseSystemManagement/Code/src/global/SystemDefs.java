...
public SystemDefs(String dbname, int num_pgs, int bufpoolsize, String replacement_policy, int kLRUK )
    {
      int logsize;
...
this(dbname, num_pgs, bufpoolsize, replacement_policy, 10);
  ...
  public void init( String dbname, String logname,
		    ...
		    int bufpoolsize, String replacement_policy, int kLRUK )
    {
      ...
      try {
	JavabaseBM = new BufMgr(bufpoolsize, replacement_policy, kLRUK);
	JavabaseDB = new DB();
/*
